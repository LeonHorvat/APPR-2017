...
Primerjal sem tudi število turistov iz posamezne države s številom potnikov v zračnem prometu iz posamezne države. Ta rezultat je lahko v pomoč letalskim družbam pri vzpostavitvi novih latalskih linij. Na spodnjem grafu je prikazana razlika med turidtičnimi prihodi in letalskimi prihodi, barva stolpca pa označuje število letalskih potnikov iz države. Torej, če je stolpec visok in temen, država predstavlja potencial za novo letalsko linijo. Upoštevati pa moramo tudi razdaljo držav; zaradi bližine sosednih držav se turisti raje odločajo za cenejšo vrsto potovanja, bolj zanimive so bolj oddaljene države.
