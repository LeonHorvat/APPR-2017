...
Črtni graf \ref{fig:graf} prikazuje gibanje prihodov tujih turistov v Slovenijo in število potnikov v zračnem prometu, ki so prispeli v Slovenijo. Vidimo, da je število prihodov tujih turistov bolj raslo kot število letalskih potnikov.

```{r graf, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Graf prihodov turistov in letalskih potnikov'}
print(g1)
```
